...
def main():
    ...
    while hero.hp() > 0 and len(monsters) > 0:
        ...
        monster_no = int(input('Enter choice: '))
        while monster_no not in range(1,len(monsters)+1):
            print("Invalid Input")
            monster_no = int(input('Enter choice: '))
        
        monster = monsters[monster_no-1]
        ...
        if attack_type == 1:
            description = hero.melee_attack(monster)
        elif attack_type == 2:
            description = hero.ranged_attack(monster)
        ...
        if monster.hp() <= 0:
            ...
            description = monster.melee_attack(hero)
            print(f'\n{description}')
